...
class AddForeignKeyToLists extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('lists', function (Blueprint $table) {
            ...
            $table->foreign('image_of_list_id')->references('id')->on('image_of_lists')->onDelete('cascade')->onUpdate('cascade');
    ...
    public function down()
    {
        Schema::table('lists', function (Blueprint $table) {
            ...
            $table->dropForeign('image_of_list_id');
        });
    }
}
